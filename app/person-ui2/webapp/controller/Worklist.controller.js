sap.ui.define([
    ...
    return BaseController.extend("personui2.controller.Worklist", {
        ...
        onDelete: function () {
            ...
            let sEntitySet = "/Delete";
            let oData = { "body": [{ Pernr: "6" }] };
        ...
        _showObject: function (oItem) {
            this.getRouter().navTo("object", {
                objectId: oItem.getBindingContext().getPath().substring("/Person".length)
            });
        },
